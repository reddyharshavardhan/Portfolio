...
const whiteAnimationLayer = document.querySelector('.white-animation-layer');
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const titles = ['Software Developer', 'Backend Developer' , 'Frontend Developer', 'AWS & Cloud Engineer'];
  ...
  const delayBetweenTitles = 2000; // Delay before switching to the next title
